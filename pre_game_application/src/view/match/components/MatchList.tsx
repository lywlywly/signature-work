    ...
    return (
      <Tr key={index}>
        ...
        >
            ...
            <div className="flex flex-col justify-between">
              <div className="flex justify-between" style={{ width: "133px" }}>
                ...
                <Tag
                  size={"sm"}
                  className={
                    (matchIndex === index ? "selecttMatch" : "defaultMatch") +
                    " matchTime"
                  }
                >
                  {match.matchTime}
              ...
              <div className="relative">
                ...
                >
                  <p
                    className="absolute text-zinc-400 text-xs"
                    style={{ top: "-14px" }}
                  >
                    {match.gameModel}
                  </p>
          ...
          <Divider
            style={index === matchList.length - 1 ? { display: "none" } : {}}
          />
        </td>
      </Tr>
    );
